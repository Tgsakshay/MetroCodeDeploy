...
class FREG0006 extends CI_Controller {
	...
	public function index()
	{
		   ...
		   // die();
			...
			$this->template->write_view('sidebar', 'default/sidebar');
			      ...
			      $this->template->write_view('content', 'admin/FREG0006/index');
	...
	public function pageOne()
	{
			...
			$this->template->write_view('sidebar', 'default/sidebar');
			         ...
			         $this->template->write_view('content', 'admin/FREG0006/pageOne');
	...
	public function pageTwo()
	{
			...
			$this->template->write_view('sidebar', 'default/sidebar');
			         ...
			         $this->template->write_view('content', 'admin/FREG0006/pageTwo');
	...
	public function suMmary()
	{
			...
			$this->template->write_view('sidebar', 'default/sidebar');
			         ...
			         $this->template->write_view('content', 'admin/FREG0006/suMmary');
	...
	public function Saveprecabgchecklist()
	{
	 
		// echo "form submitted";
		// ECHO $_POST['CBC_FBS'];
	  $data['std_cbc'] =  $this->input->post('std_cbc');
		$data['std_bt'] =  $this->input->post('std_bt');
		$data['std_creatinine'] =  $this->input->post('std_creatinine');
		$data['std_electrolyte'] =  $this->input->post('std_electrolyte');
		$data['std_lft'] =  $this->input->post('std_lft');
		$data['std_pft'] =  $this->input->post('std_pft');
		$data['std_viral'] =  $this->input->post('std_viral');
		$data['std_urine'] =  $this->input->post('std_urine');
		$data['std_blood'] =  $this->input->post('std_blood');
		$data['std_ecg'] =  $this->input->post('std_ecg');
		$data['std_xray'] =  $this->input->post('std_xray');
		$data['std_2decho'] =  $this->input->post('std_2decho');
		$data['std_cag'] =  $this->input->post('std_cag');
		$data['std_usg'] =  $this->input->post('std_usg');
		$data['std_carotid'] =  $this->input->post('std_carotid');
		$data['std_arrange'] =  $this->input->post('std_arrange');
		$data['std_start'] =  $this->input->post('std_start');
		$data['std_dental'] =  $this->input->post('std_dental');
		$data['std_female'] =  $this->input->post('std_female');
		$data['std_date'] =  date('Y-m-d h:i:s');
		
		$this->Common_model->insert1('pre_cabg_check_list',$data);
		
		echo $this->db->last_query();
		
		
	}
	public function PRECABGCHECKLIST()
	{
		    ...
		    $this->template->write_view('content', 'admin/FREG0006/PRECABGCHECKLIST');
	...
	public function operationApprovement()
	{
		    ...
		    $this->template->write_view('content', 'admin/FREG0006/operationApprovement');
	...
	public function leaveApproval()
	{
		    ...
		    $this->template->write_view('content', 'admin/FREG0006/leaveApproval');
	...
	public function highriskConsent()
	{
		    ...
		    $this->template->write_view('content', 'admin/FREG0006/highriskConsent');
						        
			$this->template->write_view('footer', 'default/footer');
			$this->template->render();
	      
	}
	public function advDrugReac()
	{
		    ...
		    $this->template->write_view('content', 'admin/FREG0006/advDrugReac');
	...
	public function patientDetails()
	{
			...
			$this->template->write_view('header', 'default/header');
			$this->template->write_view('sidebar', 'default/sidebar');
			 $data['mydata'] =$this->Common_model->get_data_by_query('select * FROM patient_details');
			
		    $this->template->write_view('content', 'admin/FREG0006/patientDetails',$data);
	...
	public function deleteRownew()
	{
		$id = $this->uri->segment(4);
		
		$this->Crud_model->delete_record_any_id('patient_details',$id,'reg_id');
		redirect('admin/FREG0006/patientDetails');
	}
	...
	public function approvalLetter()
	{
		    ...
		    $this->template->write_view('content', 'admin/FREG0006/approvalLetter');
	...
	public function bloodBank()
	{
		    ...
		    $this->template->write_view('content', 'admin/FREG0006/bloodBank');
	...
	public function savepatientDetails()
	{
		...
		// echo "form submitted";
		// ECHO $_POST['CBC_FBS'];
	  $data['first_name_id'] =  $this->input->post('first_name_id');
		$data['middle_name_id'] =  $this->input->post('middle_name_id');
		$data['last_name_id'] =  $this->input->post('last_name_id');
		$data['family_name_id'] =  $this->input->post('family_name_id');
		$data['patient_gender_id'] =  $this->input->post('patient_gender_id');
		$data['patient_age_id'] =  $this->input->post('patient_age_id');
		$data['entrydt_id'] =  date('Y-m-d h:i:s');
			
	
		$this->Common_model->insert1('patient_details',$data);
	...
	public function saveadverseDrugreactionform()
	{
	...
	$adverse_reaction1= $this->input->post('adverse_reaction1');
	$adverse_reaction2= $this->input->post('adverse_reaction2');
	$adverse_reaction3= $this->input->post('adverse_reaction3');
	// die;
		
		//print_r($checkbox);
	
		
	   // $adverse_reaction1 =  implode(",",$adverse_reaction1);	
		
		
		
		if($adverse_reaction1 == null)
		{
			$adverse_reaction1 = 0;
		}
	    ...
	    //$adverse_reaction2 =  implode(",",$adverse_reaction2);
if($adverse_reaction2 == null)
		{
			$adverse_reaction2 = 0;
		}	
		
   	    	
	    //$adverse_reaction3 =  implode(",",$adverse_reaction3);
if($adverse_reaction3 == null)
		{
			$adverse_reaction3 = 0; 
		}		
            $getradio  = $adverse_reaction1.','.$adverse_reaction2.','.$adverse_reaction3;			
 	 // die;
		 $getcheckbox =  implode("," , $checkbox);		
	   	$data['std_recdt'] =  $this->input->post('std_recdt');
		$data['std_recdt2'] =  $this->input->post('std_recdt2');
		$data['std_dtrecover'] =  $this->input->post('std_dtrecover');
		$data['std_writing'] =  $this->input->post('std_writing');
		$data['std_problem'] =  $this->input->post('std_problem');
		$data['std_contrast'] =  $this->input->post('std_contrast');
		$data['std_dtstart'] =  $this->input->post('std_dtstart');
		$data['std_dtstop'] =  $this->input->post('std_dtstop');
		$data['std_adr'] =  $getradio ;
		$data['std_adv_rec_chxbox'] =  $getcheckbox ;
		$data['std_entrydt'] =  date('Y-m-d h:i:s');
		
		// print_r($data) ;
		// die();
		 echo $this->Common_model->insert1('adverse_drug_reaction',$data);
...
else
{
	...
	if($filed=='first_name')
	{
	  $querry .= " and first_name REGEXP '^$data' ";
	}
	else if($filed=='last_name')
	{
	  $querry .= " and last_name REGEXP '^$data' ";
	}
 else if($filed=='id')
	{
	  $querry .= " and id='$data'";
		...
		function validationcheklimit()
		{
				...
				<table  id="sample_editable_1" cellpadding="4" cellspacing="0" width="100%" border="0" class="CSSTableGenerator10">
                          <tbody  id='opdresult'>
							  ...
							  foreach($result as $ft){
							   $uhid=$ft['limit_uhid'];
							   $appldate=date('Y-m-d h:i',strtotime($ft['limit_entrydt']));
							   
							   
								$hospital = $this->Common_model->get_data_by_query("select sum(tran_amount) as total from transaction_bill where  date_format(tran_entrydt,'%Y-%m-%d h:i')>= '$appldate' and  tran_uhid=$uhid "); 
								
								
								$inves = $this->Common_model->get_data_by_query("select sum(tran_amount) as total from transaction where  date_format(tran_entrydt,'%Y-%m-%d h:i')>= '$appldate' and  tran_uhid=$uhid ");
								
                      $medi = $this->Common_model->get_data_by_query("select sum(invoice_amt) as total from pd_invoice_cr where  date_format(invoice_entrydt,'%Y-%m-%d h:i')>= '$appldate' and  invoice_uhid=$uhid "); 
                        ...
                        <tr>
                                <td><center><?php echo $ft['limit_total_amt']; ?></center></td>
                                 <td><center><?php echo $medicin; ?></center></td>
                                <td><center><?php echo $inves; ?></center></td>
                                 <td><center><?php echo $hospital; ?></center></td>
							  ...
							  <?php } ?>
							   <tr>
                        <td colspan="1" style="font-size:14px; color:#00C;"><strong>Balance </strong></td>
                        <td colspan="1" style="font-size:14px; color:#00C;"><strong><center><?php echo $medicin1; ?></center></strong></td>
                        <td colspan="1" style="font-size:14px; color:#00C;"><strong><center> <?php echo $investi1;?></center></strong></td>
                        <td colspan="1" style="font-size:14px; color:#00C;"><strong><center> <?php echo $hospital1; ?></center></strong></td>
                        <td colspan="1" style="font-size:14px; color:#00C;"><strong><center> <?php //echo $this->Crud_model->GetLimitAmount() ?></center></strong></td>
